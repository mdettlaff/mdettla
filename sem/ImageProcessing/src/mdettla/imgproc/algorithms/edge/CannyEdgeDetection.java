...
import mdettla.imgproc.algorithms.simple.GaussianBlur;

public class CannyEdgeDetection implements ImageProcessingAlgorithm {
	...
	private static int pixelEdgeDirection(int x, int y, BufferedImage image) {
		...
		if (theta < 0 || theta > 180) {
			throw new AssertionError("Nieprawidłowa wartość kąta theta");
		}
		int direction;
