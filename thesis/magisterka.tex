...
Wyniki dla operatorów krzyżowania Cycle Crossover (CX) oraz Partially-Mapped Crossover (PMX) przedstawiono poniżej, również uśrednione dla 10 uruchomień algorytmu.
