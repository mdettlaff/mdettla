...
public class SAXNamespacesBlock{
	...
	public void performDemo(String uri){
		...
		try {
			...
			ChangeNamespaceFilter filtr1=new ChangeNamespaceFilter();
			filtr1.setParent(parser);

			BlockStreamFilter filtr2=new BlockStreamFilter();
			filtr2.setParent(filtr1);
			
			filtr2.setContentHandler(contentHandler);
			filtr2.setErrorHandler(errorHandler);
			filtr2.parse(uri);
	...
	public static void main(String[] args){
		...
		String uri=args[0];
		SAXNamespacesBlock parserDemo=new SAXNamespacesBlock();
