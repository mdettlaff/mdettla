...
echo("Dziękuję, ".$_POST['autor'].", za wpisanie się do księgi!<br><br><br>");
echo("<a href=ksiega.php>Powrót do księgi gości</a>");
...
{
echo("Musisz podać swoje imię i komentarz.<br><br><br>");
echo("<a href=\"ksiega.php?action=form\"><b>Powrót do formularza</b></a>");
}
elseif($c==1)
{
echo("Przykro mi, ale twój komentarz nie przeszedł naszej kontroli antyspamowej.<br><br><br>");
echo("<a href=\"ksiega.php?action=form\"><b>Powrót do formularza</b></a>");
}
elseif($_COOKIE[antyflood]=='1')
{
echo("Można się wpisać tylko raz.<br><br><br>");
echo("<a href=ksiega.php>Powrót do księgi gości</a>");
}
else
{
echo("Błąd skryptu.<br><br><br>");
echo("<a href=ksiega.php>Powrót do księgi gości</a>");
}
