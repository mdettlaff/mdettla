...
public class TypingTest extends Applet
  ...
  void drawInBuffer() {
    ...
    if (showWelcome) {
      ...
      buffer.drawString("Test prędkości pisania", width/2-90, height/2-100);
      buffer.setFont(fontSmall);
      buffer.drawString("Po przepisaniu każdej linii naciśnij ENTER",
		           width/2-137, height/2-40);
      buffer.drawString("Czas zacznie być mierzony, kiedy zaczniesz pisać",
		           width/2-158, height/2-15);
      buffer.drawString("F2 wyłącza/włącza polskie znaki",
		           width/2-108, height/2+10);
      buffer.setFont(fontBig);
      buffer.drawString("Kliknij, aby rozpocząć", width/2-90, height/2+50);
      buffer.setColor(Color.BLUE);
      buffer.drawString("autor: Michał Dettlaff", width/2-88, height/2+112);
      buffer.setColor(Color.BLACK);
	...
	buffer.drawString("Wynik: " + String.format("%.1f", speed) +
	  " znaków/min, " + mistakesCount + " błędów (" + charsTyped +
	...
	buffer.drawString("Naciśnij ENTER, aby rozpocząć kolejny test",
   ...
   *
   * @param  corpus     Tekst jako ciąg słów, na podstawie którego generowany
   *                    jest łańcuch Markowa.
  ...
  public String generateMarkovChain(List<String> corpus, int minTextLen)
  {
    ...
    while (!(markovText.length() > minTextLen && markovText.endsWith(". "))) {
      // słowa występujące w danym tekście zaraz po ostatnim słowie z łańcucha
  ...
  public String getAppletInfo() {
    return "Test prędkości pisania. Używa plików tekstowych z katalogu określonego parametrem.";
  }
}
...
class Text extends ArrayList<String> {
  ...
  public void removePolishChars() {
    for (int i=0; i < size(); i++) {
      set(i, get(i).replace('ą', 'a'));
      set(i, get(i).replace('ć', 'c'));
      set(i, get(i).replace('ę', 'e'));
      set(i, get(i).replace('ł', 'l'));
      set(i, get(i).replace('ń', 'n'));
      set(i, get(i).replace('ó', 'o'));
      set(i, get(i).replace('ś', 's'));
      set(i, get(i).replace('ż', 'z'));
      set(i, get(i).replace('ź', 'z'));
