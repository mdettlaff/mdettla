/*
Zamienia polskie znaki z ogonkami na litery lacinskie w podanych plikach
Uzycie: ogonki [pliki...]
 */
...
/* sprawdzenie, czy podano plik do przepisania */
  if (argc < 2){
    printf("Zamienia polskie znaki z ogonkami na litery lacinskie\n");
    printf("Uzycie: ogonki [pliki...]\n");
  }
  else
  {
    for (j=1; j < argc; j++) {
