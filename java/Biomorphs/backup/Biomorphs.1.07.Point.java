...
class Biomorph {
  ...
  Biomorph(int frontAngle, int rearAngle, int frontElongation,
      int rearElongation, double expandX, double expandY,
      int iterations, double gradient, Color color, String shape) {
    this.frontAngle = frontAngle;
    this.rearAngle = rearAngle;
    this.frontElongation = frontElongation;
    this.rearElongation = rearElongation;
...
class GenerationCanvas extends Canvas implements MouseListener {
  ...
  public void drawBuffer() {
    ...
    drawBiomorph(buffer, new Point(BM_W*0+BM_W/2, BM_H*0+DY),
	parent, INIT_ANGLE, parent.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*1+BM_W/2, BM_H*0+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*2+BM_W/2, BM_H*0+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*3+BM_W/2, BM_H*0+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*4+BM_W/2, BM_H*0+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*0+BM_W/2, BM_H*1+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*1+BM_W/2, BM_H*1+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*2+BM_W/2, BM_H*1+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*3+BM_W/2, BM_H*1+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*4+BM_W/2, BM_H*1+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*0+BM_W/2, BM_H*2+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*1+BM_W/2, BM_H*2+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*2+BM_W/2, BM_H*2+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*3+BM_W/2, BM_H*2+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*4+BM_W/2, BM_H*2+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*0+BM_W/2, BM_H*3+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*1+BM_W/2, BM_H*3+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*2+BM_W/2, BM_H*3+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*3+BM_W/2, BM_H*3+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
    drawBiomorph(buffer, new Point(BM_W*4+BM_W/2, BM_H*3+DY),
	child=childIter.next(), INIT_ANGLE, child.frontElongation);
  ...
  void drawBiomorph(Graphics g, Point cursor, Biomorph bm, int angle,
      int elongation) {
    // zakres kata od 0 do 359 stopni
   ...
   * wspolczynnik.
   */
  Point drawShapeAngle(Graphics g, Point start, int angle, int len,
    ...
    dest = new Point(start.x + (int) diffXD, start.y + (int) diffYD);
    g.setColor(color);
    if (shape == "line") {
