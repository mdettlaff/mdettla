...
/* <applet width=635 height=320 code="TypingTest.class"></applet> */
...
public class TypingTest extends Applet
  ...
  void drawInBuffer() {
    ...
    if (showWelcome) {
      ...
      buffer.drawString("Test prêdkoœci pisania", width/2-90, height/2-90);
      buffer.setFont(fontSmall);
      buffer.drawString("Po przepisaniu ka¿dej linii naciœnij ENTER",
		           width/2-132, height/2-30);
      buffer.drawString("Czas zacznie byæ mierzony, kiedy zaczniesz pisaæ",
		           width/2-155, height/2-5);
      buffer.setFont(fontBig);
      buffer.drawString("Kliknij, aby rozpocz¹æ", width/2-90, height/2+35);
      buffer.setColor(Color.BLUE);
      buffer.drawString("autor: Micha³ Dettlaff", width/2-88, height/2+100);
      buffer.setColor(Color.BLACK);
	...
	long typingTimeS = (timeFinished - timeStarted) / 1000; // w sekundach
